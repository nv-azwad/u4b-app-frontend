  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        // 2. Switch back to login view so they can login after verifying
        setIsLogin(true);
        // 3. DO NOT redirect or setToken because they are not verified yet
      }
          ...
          {isLogin && (
            <div className="text-right mb-4">
              <button
                ...
                className="text-xs text-[#417FA2] hover:underline"
              >
                Forgot Password?
              </button>
            </div>
